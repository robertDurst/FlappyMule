...
def collision(Thing1,Thing2,dt):
	...
	t2 = Thing2.getType()
	if t1 == 'ball':
		fun = collision_router[(t1,t2)]
		return fun(Thing1,Thing2,dt)
	else:
		fun = collision_router[(t2,t1)]
		return fun(Thing2,Thing1,dt)
# #def collision(obj1,obj2,time_step):
# # obj1_type = obj1.getType()
# # obj2_type = obj2.getType()
#	if obj1_type != 'ball':
#		obj2_type = obj1_type
#		obj1_type = 'ball'
#		temp = obj1
#		obj1 = obj2
#		obj2 = temp
#	return collision_router[obj1_type,obj2_type](obj1,obj2,time_step)